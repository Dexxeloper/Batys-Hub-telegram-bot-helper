...
keyboard = [
    ["📌 О хабе", "📅 Регистрация в клуб разработчиков"],
    ["🧑‍💻 Резидентство", "📞 Instagram"],
    ["❓ FAQ"]
]
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📌 О хабе":
        ...
        await update.message.reply_text("Вы можете зарегистрироваться по ссылке в нашем инстаграме Taplink")
        ...
        await update.message.reply_text("Instagram: Batys.hub")
